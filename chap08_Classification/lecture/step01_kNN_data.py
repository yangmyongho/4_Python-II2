# -*- coding: utf-8 -*-
"""
Created on Mon May 18 10:11:39 2020
...
plt.scatter(1.0, 1.0)# A 집단
plt.scatter(1.8, 0.8) # B 집단 
plt.scatter(2, 0.9)# B 집단 
...
def data_set():
    # 선형대수 연산 : numpy형 변환 
    know_group = np.array([p1, p2, p3, p4]) # 중첩리스트 - 2차원 # 알려진 집단 
...
def data_set() :
    know_group = np.array([p1, p2, p3, p4])
    not_know_group = np.array(p5)
...
not_know.shape # (2,)
cate.shape # (4,)
# know와 not_know 브로드캐스트 연산이 가능하다. 
# not_know가 밑에 3개가 더붙여져서 1-1연산이 가능하도록 for 거리계산
